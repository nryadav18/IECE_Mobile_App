# -*- coding: utf-8 -*-
# MiniFASNet_v2.py — local copy for Render deployment
# Copied from root MiniFASNet.py so ml_service folder is self-contained.
# @Original Author : zhuying @ Minivision
